...
public final class AddPCRVisitor0 extends DumpVisitor {
	...
	public static String	pthis;
	public static String	cthis;
	public static String	rthisString;
		...
		if (inrContainer) {
			...
			if (rline >= n.getBeginLine() && rline <= n.getEndLine()) {
				...
				if (n.toString().contains(rInvokeAPIName)) {
					rthisString = n.getScope().toString();
				} else {
					throw new RuntimeException("assertion fails");
				}
			}
