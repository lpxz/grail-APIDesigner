...
public class AddEnterExitComposition {
	...
	public static void main(String[] args) {
		...
		for (SerializableComposition composition : deserializedCompositions) {
			...
			addEnterExitComposition(composition);
	...
	public static void addEnterExitComposition(
		...
		try {
			...
			AddEnterExitMonitorVisitor visitor = new AddEnterExitMonitorVisitor();
