...
public class RunMonitorUtil implements Cloneable {
	...
	public static String getTmpReplayDirectory() {
		...
		tempdir = tempdir + Parameters.SRC_DIR
	...
	public static String getTmpTransDirectory() {
		...
		tempdir = tempdir + Parameters.TEMP_DIR
				+ System.getProperty("file.separator");
		return tempdir;
	}
	...
	public static boolean shouldInstruThisClass(String scname) {
		...
		if (scname.startsWith("java.") || scname.startsWith("javax.")
				|| scname.startsWith("com.sun.")
				|| scname.startsWith("java.awt.event.NativeLibLoader.")
				|| scname.startsWith("sun.") || scname.startsWith("junit.")
				|| scname.startsWith("org.junit.")
				|| scname.startsWith("org.xmlpull.")
				|| scname.startsWith("edu.") || scname.startsWith("javato.")) {
			return false;
		}
		...
		if (scname.contains("InputStream")
				...
				|| scname.contains("junit.") || scname.contains("org.junit.")
	...
	public static boolean shouldInstruThisMethod(String smname) {
		if (smname.startsWith("java.") || smname.startsWith("javax.")
				|| smname.startsWith("com.sun.")
				|| smname.startsWith("java.awt.event.NativeLibLoader.")
				|| smname.startsWith("sun.") || smname.startsWith("junit.")
				|| smname.startsWith("org.junit.")
				|| smname.startsWith("org.xmlpull.")
				|| smname.startsWith("edu.") || smname.startsWith("javato.")) {
			return false;
		}
		...
		if (smname.contains("InputStream")
				...
				|| smname.contains("junit.") || smname.contains("org.junit.")
				|| smname.contains("checkers.")
				|| smname.contains("org.xmlpull.")) {
			return false;
		}

		if (smname.contains("readExternal") || smname.contains("writeExternal")
				|| smname.contains("hashCode") || smname.contains("equals")
				|| smname.contains("<clinit>") || smname.contains("<init>")) {
			return false;
		}
