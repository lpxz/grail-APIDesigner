...
public class Order {
    ...
    public boolean processLines(Warehouse inWarehousePtr,
    ...
    public void dateOrderlines(Date orderdate) {
        int i;
        Orderline orderline;
        if (JBButil.getLog().isLoggable(Level.FINEST)) {
            JBButil.getLog().finest(
    ...
    public void setAllLocal(boolean inAllLocal) {
        allLocal = inAllLocal;
    }

    public void setEntryDateTime(Date inEntryDateTime) {
