...
public class Warehouse {
    ...
    public void trimOrdersForSteadyState(int initialOrders,
    ...
    public void loadStockTable() {
        ...
        Item currItem;
        Stock newStock;
        //The itemTable contains items with keys in a continuous sequence from 1 to some number numItems
        // The key is incidentally the id of the item as well
