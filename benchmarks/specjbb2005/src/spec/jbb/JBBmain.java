...
public class JBBmain implements Runnable {
    ...
    public static final String   Version               = "SPECjbb2005 1.07";

    public static final String   VersionDate           = "March 15, 2006";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            boolean passed_validation = true;
            main = null;
            scratch1.close();
            scratch2.close();
