...
public class MultiVMReport {
	...
	this(output_directory, SPECInternalUse, newsletter, useHtml,
	     echoRaw, "000", "SPECjbb.");
    }

    public MultiVMReport(String output_directory, boolean SPECInternalUse,
            String newsletter, boolean useHtml, boolean echoRaw, String labelImg, 
	    String prefix) {
    ...
    public void print(PrintStream out) {
        ...
        try {
            ...
            out.print("<FONT SIZE=+2>" + name + "2005</FONT></TD>\n"
                    ...
                    + "    <FONT SIZE=+2 COLOR=000000><B> SPECjbb2005 bops = " + metric1
                    + ", SPECjbb2005 bops/JVM = " + metric2 + "</B></FONT></TD></TR>\n"
		...
		out.print("<TR><TD COLSPAN=3><font size=+2>INVALID because " 
            ...
            out.println("<TR><TH COLSPAN=2> SPECjbb2005 bops = "
                    + metric1
                    + ", SPECjbb2005 bops/JVM = "
                    + metric2
                    + "</TABLE></TD><TD>"
                    + Metrics.multiCurvesGraph(metrics, labelImg, SPECInternalUse,
